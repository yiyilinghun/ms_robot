...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
    ...
    m_wndOutputRobotLog.Create(dwStyle, rectDummy, &m_wndTabs, 2);
    ...
    // 将列表窗口附加到选项卡: 
    bNameValid = strTabName.LoadString(IDS_ROBOT_LOG_TAB);
    ASSERT(bNameValid);
    m_wndTabs.AddTab(&m_wndOutputRobotLog, strTabName, (UINT)0);
...
void COutputWnd::ClearRobotLogWindow()
{
    m_wndOutputRobotLog.ResetContent();
}

void COutputWnd::FillRobotLogWindow(CString xLog)
{
    m_wndOutputRobotLog.AddString(xLog);
}
...
{
    m_wndOutputRobotLog.SetFont(&afxGlobalData.fontRegular);
