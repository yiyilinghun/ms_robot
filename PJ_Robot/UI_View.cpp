...
BEGIN_MESSAGE_MAP(UI_View, CDockablePane)
    ON_WM_CREATE()
    ON_WM_SIZE()
    ON_WM_CONTEXTMENU()
    ...
    ON_WM_PAINT()
    ON_WM_SETFOCUS()
    //ON_COMMAND(ID_CREATE_ROBOT_1, &UI_View::OnCreateRobot1)
    //ON_COMMAND(ID_CREATE_ROBOT_2, &UI_View::OnCreateRobot2)
    //ON_COMMAND(ID_CREATE_ROBOT_5, &UI_View::OnCreateRobot5)
    //ON_COMMAND(ID_CREATE_ROBOT_10, &UI_View::OnCreateRobot10)
    //ON_COMMAND(ID_CREATE_ROBOT_50, &UI_View::OnCreateRobot50)
    //ON_COMMAND(ID_CREATE_ROBOT_100, &UI_View::OnCreateRobot100)
    //ON_COMMAND(ID_CREATE_ROBOT_500, &UI_View::OnCreateRobot500)
    //ON_COMMAND(ID_CREATE_ROBOT_1000, &UI_View::OnCreateRobot1000)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CWorkspaceBar 消息处理程序

int UI_View::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void UI_View::OnSize(UINT nType, int cx, int cy)
{
    CDockablePane::OnSize(nType, cx, cy);
    AdjustLayout();
}

void UI_View::FillFileView()
{
...
void UI_View::OnContextMenu(CWnd* pWnd, CPoint point)
{
...
void UI_View::OnProperties()
{
    AfxMessageBox(_T("属性...."));

}

void UI_View::OnFileOpen()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnFileOpenWith()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnDummyCompile()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnEditCut()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnEditCopy()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnEditClear()
{
    // TODO: 在此处添加命令处理程序代码
}

void UI_View::OnPaint()
{
...
void UI_View::OnSetFocus(CWnd* pOldWnd)
{
...
void UI_View::OnChangeVisualStyle()
{
...
//
//void UI_View::CreateRobot(Int32 xRobotCount)
//{
...
//}
//
//void UI_View::OnCreateRobot1()
//{
//    this->CreateRobot(1);
//}
//
//void UI_View::OnCreateRobot2()
//{
//    this->CreateRobot(2);
//}
//
//
//void UI_View::OnCreateRobot5()
//{
//    this->CreateRobot(5);
//}
//
//
//void UI_View::OnCreateRobot10()
//{
//    this->CreateRobot(10);
//}
//
//
//void UI_View::OnCreateRobot50()
//{
//    this->CreateRobot(50);
//}
//
//void UI_View::OnCreateRobot100()
//{
//    this->CreateRobot(100);
//}
//
//
//void UI_View::OnCreateRobot500()
//{
//    this->CreateRobot(500);
//}
//
//
//void UI_View::OnCreateRobot1000()
//{
