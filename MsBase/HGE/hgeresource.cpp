...
//    else
//    {
//        reshandle = G_HGE->Resource_Load(name);
//        if (reshandle)
//        {
...
//    else
//    {
//        reshandle = G_HGE->Texture_LoadFromFile(name);
//        if (reshandle)
//        {
//            resource = new RTexture();
//            resource->handle = (void*)(ULONG_PTR)reshandle;
//            resource->resgroup = resgroup;
...
//    else
//    {
//        reshandle = G_HGE->Effect_FromFile(name);
//        if (reshandle)
//        {
...
//    else
//    {
//        reshandle = G_HGE->Music_Load(name);
//        if (reshandle)
//        {
//            resource = new RMusic();
//            resource->handle = (void*)(ULONG_PTR)reshandle;
...
//    else
//    {
//        reshandle = G_HGE->Stream_FromFile(name);
//        if (reshandle)
//        {
