...
#define BASSDEF(f) WINAPI f
    ...
    typedef void* HMUSIC;		// MOD music handle
    typedef void* HSAMPLE;		// sample handle
    typedef void* HCHANNEL;		// playing sample's channel handle
    typedef void* HSTREAM;		// sample stream handle
    typedef void* HRECORD;		// recording handle
    typedef void* HSYNC;		// synchronizer handle
    typedef void* HDSP;			// DSP handle
    typedef void* HFX;			// DX8 effect handle
    typedef void* HPLUGIN;		// Plugin handle
