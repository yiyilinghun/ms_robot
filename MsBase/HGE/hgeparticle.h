...
public:
    ...
    hgeParticleSystem(HGE* hge, const char *filename, hgeSprite *sprite);
    hgeParticleSystem(HGE* hge, hgeParticleSystemInfo *psi);
    hgeParticleSystem(HGE* hge, const hgeParticleSystem &ps);
...
public:
    ...
    hgeParticleSystem*  SpawnPS(HGE* hge, hgeParticleSystemInfo *psi, float x, float y);
