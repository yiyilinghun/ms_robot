...
//
//        data = G_HGE->Resource_Load(sname, &size);
//        if (!data)
//        {
//            if (sp) sp->ScriptPostError("Script ", " not found.");
//            else G_HGE->System_Log("Script '%s' not found.", sname);
//            delete res_script;
//            return;
//        }
//        else
...
//{
//    if (!handle) handle = G_HGE->Resource_Load(filename);
//    return handle;
//}
//
//void RResource::Free()
//{
//    if (handle) G_HGE->Resource_Free((void *)handle);
//    handle = 0;
//}
//
///////////////// RTexture //
...
//{
//    if (!handle) handle = (void*)(ULONG_PTR)G_HGE->Texture_LoadFromFile(filename, 0, mipmap);
//    return handle;
//}
//
//void RTexture::Free()
//{
//    if (handle) G_HGE->Texture_Free((HTEXTURE)handle);
//    handle = 0;
//}
//
///////////////// REffect //
...
//{
//    if (!handle) handle = (void*)(ULONG_PTR)G_HGE->Effect_FromFile(filename);
//    return handle;
//}
//
//void REffect::Free()
//{
//    if (handle) G_HGE->Effect_Free((HEFFECT)handle);
//    handle = 0;
//}
//
///////////////// RMusic //
...
//    if (!handle)
//    {
//        handle = (void*)(ULONG_PTR)G_HGE->Music_Load(filename);
//        G_HGE->Music_SetAmplification((HMUSIC)handle, amplify);
//    }
//
//    return handle;
//}
...
//void RMusic::Free()
//{
//    if (handle) G_HGE->Music_Free((HMUSIC)handle);
//    handle = 0;
//}
//
///////////////// RStream //
...
//{
//    if (!handle) handle = (void*)(ULONG_PTR)G_HGE->Stream_FromFile(filename);
//    return handle;
//}
//
//void RStream::Free()
//{
//    if (handle) G_HGE->Stream_Free((HSTREAM)handle);
//    handle = 0;
//}
//
///////////////// RTarget //
...
//{
//    if (!handle) handle = (void*)(ULONG_PTR)G_HGE->Target_Create(width, height, zbuffer);
//    return handle;
//}
//
//void RTarget::Free()
//{
//    if (handle) G_HGE->Target_Free((HTARGET)handle);
//    handle = 0;
//}
//
///////////////// RSprite //
...
//{
//    if (!handle)	handle = new hgeStringTable(filename);
//    return handle;
//}
//
