...
{
public:
    hgeGUIObject() { /*hge=hgeCreate(HGE_VERSION);*/ color = 0xFFFFFFFF; bEnabled = true; bVisible = true; }
    virtual         ~hgeGUIObject() { /*hge->Release();*/ }

    virtual void    Render(__int64 xNow) = 0;
...
public:
    ...
    virtual void    AddCtrl(hgeGUIObject *ctrl);
    virtual void    DelCtrl(int id);
    ...
    int             Update(float dt);
    virtual int     Render(__int64 xNow);
