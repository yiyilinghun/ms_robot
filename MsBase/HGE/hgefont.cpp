...
//#include <stdio.h>
//
//const char FNTHEADERTAG[] = "[_HGEFONT]";
...
//
//    data = G_HGE->Resource_Load(szFont, &size);
//    if (!data) return;
//
...
//    {
//        G_HGE->System_Log("Font %s has incorrect format.", szFont);
//        delete[] desc;
//        return;
//    }
//
...
//
//            hTexture = G_HGE->Texture_LoadFromFile(buf, 0, bMipmap);
//            if (!hTexture)
//            {
//                delete[] desc;
//                return;
...
//    if (hTexture) G_HGE->Texture_Free(hTexture);
//    G_HGE->Release();
//}
//
