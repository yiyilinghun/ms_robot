...
HZIP CreateZip(LPCSTR fn, LPCSTR password);
HZIP CreateZip(void *buf, unsigned int len, LPCSTR password);
HZIP CreateZipHandle(HANDLE h, LPCSTR password);
...
ZRESULT ZipAdd(HZIP hz, LPCSTR dstzn, LPCSTR fn);
ZRESULT ZipAdd(HZIP hz, LPCSTR dstzn, void *src, unsigned int len);
ZRESULT ZipAddHandle(HZIP hz, LPCSTR dstzn, HANDLE h);
ZRESULT ZipAddHandle(HZIP hz, LPCSTR dstzn, HANDLE h, unsigned int len);
ZRESULT ZipAddFolder(HZIP hz, LPCSTR dstzn);
