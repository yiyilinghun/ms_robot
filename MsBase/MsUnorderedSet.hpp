...
class MsUnorderedSet
{
public:
    MsUnorderedSet() { }
    MsUnorderedSet(google::protobuf::RepeatedField<TKey>* xRepeatedValue) { this->LoadFromProto(xRepeatedValue); m_It = m_Container.begin(); }
    MsUnorderedSet(google::protobuf::RepeatedPtrField<TKey>* xRepeatedValue) { this->LoadFromProto(xRepeatedValue); m_It = m_Container.begin(); }
...
public:
    std::unordered_set<TKey> m_Container;
    typename std::unordered_set<TKey>::iterator m_It;
};
