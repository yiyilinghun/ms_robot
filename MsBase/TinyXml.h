...
namespace tinyxml2
{
    ...
    */
    ...
    public:
        ...
        */
        bool m_IsLastOpOk = true;
        operator bool() const { return m_IsLastOpOk; }
        XMLElement* GetPointer() { return (XMLElement*)this; }
        XMLElement& operator[](const char* value)
        {
            auto* xRet = FirstChildElement(value);
            if (xRet)
            {
                m_IsLastOpOk = true;
